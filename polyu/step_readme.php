...
    <div class="tab-pane fade active in" id="step1">
		...
		<p>登入 <a href="https://www38.polyu.edu.hk/eStudent/login.jsf" target="_blank">eStudent</a></p>
		<p class="title">等待網頁完全下截完成後，按滑鼠右鍵，選取view page source （或使用鍵盤上Ctrl ＋U) ，讀取網頁編碼</p>
		<p><img src="<?=DOC_URL?>polyu/pu101.jpg" ></p>		
		<br>
		<p class="title">打開 2015-16 Sem 1 的時間表:</p>
		<p><img src="<?=DOC_URL?>polyu/pu102.jpg" ></p>
